...
<body>
    ...
    <section class="content-main">
        <div class="content-header">
            <div>
                <h2 class="content-title card-title">In-Office Bookings</h2>
            </div>
                    ...
                    <table id="tableData" class="table table-hover display">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('officebooking.details', $booking->id) }}" class="btn btn-success font-sm"><i class="material-icons md-visibility"></i></a>
                                    <form action="{{ route('officebooking.destroy', $booking->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
