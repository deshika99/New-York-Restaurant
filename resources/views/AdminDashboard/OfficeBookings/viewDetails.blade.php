...
<body>
    ...
    <section class="content-main">
        <div class="content-header">
            ...
            <a href="{{route('viewOfficeBookings')}}" class="btn btn-dark font-sm"><i class="material-icons md-arrow_back"></i></a>
        </div>
        <div class="content-header">
            <h4 class="">Booking ID: IB{{$booking->id}}</h4>
            <a href="{{route('office.bookingPrint',$booking->id)}}" class="btn btn-success font-sm"><i class="material-icons md-print"></i></a>
        </div>
        <!-- Room Type Form -->
        <div class="card">
            <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form action="{{ route('office.updateStatus',$booking->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="mb-4 col-md-12">
